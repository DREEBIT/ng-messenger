...
var VirtualScrollComponent = (function () {
    ...
    VirtualScrollComponent.prototype.calculateItems = function () {
        ...
        if (this.heightForIndex) {
            if (items.length != this.itemHeights.length) {
                this.itemHeights = items.map(function (item, index) {
                    return _this.heightForIndex(item, index);
                });
                var height_1 = 0;
                this.itemHeights.forEach(function (item) {
                    height_1 += item;
                });
                this.scrollHeight = height_1 / d.itemsPerRow;
            }
        }
        else {
    ...
    ], VirtualScrollComponent.prototype, "heightForIndex", void 0);
    __decorate([
        core_1.Output(), 
